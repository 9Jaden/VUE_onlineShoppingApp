  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ selected.consignee }}</span>
        <span>{{ selected.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.selected.consignee,
        consigneeTel: this.selected.phoneNum,
        deliveryAddress: this.selected.fullAddress,
        paymentWay: "ONLINE",
